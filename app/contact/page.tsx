...
const Contact = () => {
  ...
  return (
    <section className="relative min-h-screen w-full">
      {/* Background */}
      <div className="absolute inset-0 z-0 max-[1024px]:fixed">
        <Image
          src="/mumbai.jpg"
      ...
      {/* ===== Mobile (stacked) ===== */}
      <div
        className="relative z-10 min-[1025px]:hidden px-4 pt-28 pb-8 space-y-4"
      ...
      <div className="hidden min-[1025px]:block absolute bottom-40 left-6  z-10">
      ...
      <div className="hidden min-[1025px]:block absolute bottom-6 right-[33px] z-10 w-[min(80vw,441px)] overflow-visible">
      ...
      {/* Footer */}
      <div className="hidden min-[1025px]:block absolute bottom-2 left-1/2 -translate-x-1/2 text-center text-white text-xs z-10">
        © {new Date().getFullYear()} Lotus Med Innovation LLC. <br /> All Rights Reserved.
      </div>
    </section>
  );
